    ...
    >
      <defs>
        <linearGradient id="TrunkGradient">
          <stop offset="0%" stop-color="#5A3113" />
          <stop offset="50%" stop-color="#b8662a" />
          <stop offset="100%" stop-color="#5A3113" />
        </linearGradient>
        <linearGradient id="LeaveGradient" x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stop-color="#32c953" />
          <stop offset="100%" stop-color="#194723" />
        </linearGradient>
      </defs>
